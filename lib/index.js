...
var NotificationHelper = /** @class */ (function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.getPayload(title, message, payloadTitle, payloadMsg, notificationType, cta, img)];
                    case 1:
                        payload = _d.sent();
    ...
    NotificationHelper.prototype.getPayloadHash = function (user, title, message, payloadTitle, payloadMsg, notificationType, cta, img, simulate) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getPayload(title, message, payloadTitle, payloadMsg, notificationType, cta, img)];
                    case 1:
                        payload = _a.sent();
     ...
     * @returns
     */
    NotificationHelper.prototype.getPayload = function (title, message, payloadTitle, payloadMsg, notificationType, cta, img) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, epnsNotifyHelper_1.default.preparePayload(null, // Recipient Address | Useful for encryption

...
var DEFAULT_NOTIFICATION_CHAIN = '42';
var NotificationHelper = /** @class */ (function () {
    ...
    function NotificationHelper(channelKey, _a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.communicatorContractAddress, communicatorContractAddress = _c === void 0 ? config_1.default.communicatorContractAddress : _c, _d = _b.communicatorContractABI, communicatorContractABI = _d === void 0 ? config_1.default.communicatorContractABI : _d, _e = _b.channelAddress, channelAddress = _e === void 0 ? null : _e, _f = _b.networkKeys, networkKeys = _f === void 0 ? DEFAULT_NETWORK_SETTINGS : _f, _g = _b.notificationChainId, notificationChainId = _g === void 0 ? DEFAULT_NOTIFICATION_CHAIN : _g;
        ...
        this.epnsCommunicatorSettings = {
            ...
            contractAddress: communicatorContractAddress[notificationChainId],
    ...
    NotificationHelper.prototype.getContract = function (chainId, address, abi) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, epnsNotifyHelper_1.default.getInteractableContracts(chainId, // Network for which the interactable contract is req
                    {
                        // API Keys
    ...
    NotificationHelper.prototype.sendNotification = function (user, title, message, payloadTitle, payloadMsg, notificationType, cta, img, simulate, _a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.offChain, offChain = _c === void 0 ? true : _c;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        payload = _d.sent();
                        return [4 /*yield*/, epnsNotifyHelper_1.default.sendOffchainNotification(this.epnsCommunicatorSettings, payload, this.channelKey, user, channelAddress)];
                    case 2:
                        response = _d.sent();

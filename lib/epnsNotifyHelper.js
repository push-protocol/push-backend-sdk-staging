...
exports.default = {
    generateOffChainSignature: function (communicatorDetails, payload, channelPrivateKey, recipientAddr, channelAddress) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    sendOffchainNotification: function (backendPayload) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, (0, axios_1.postReq)('/payloads/add_manual_payload', __assign({}, backendPayload))
                    .then(function (_a) {
                    var data = _a.data, status = _a.status;
                    return __assign(__assign({}, data), { statusCode: status });
                })
                    .catch(function (err) {
                    var _a = JSON.parse(JSON.stringify(err)), status = _a.status, message = _a.message;

...
var getOffChainPayload = function (communicatorDetails, payload, channelPrivateKey, recipientAddr, channelAddress) { return __awaiter(void 0, void 0, void 0, function () {
    var chainId, verifyingContract, wallet, DOMAIN, TYPE, MESSAGE, signature, backendPayload;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                chainId = communicatorDetails.network;
                verifyingContract = communicatorDetails.contractAddress;
            ...
            case 1:
                ...
                return [2 /*return*/, backendPayload];
        }
    });
}); };
exports.default = {
    getOffChainPayload: getOffChainPayload,
    sendOffchainNotification: function (communicatorDetails, payload, channelPrivateKey, recipientAddr, channelAddress) { return __awaiter(void 0, void 0, void 0, function () {
        var backendPayload;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getOffChainPayload(communicatorDetails, payload, channelPrivateKey, recipientAddr, channelAddress)];
                case 1:
                    backendPayload = _a.sent();
                    console.log('\n\n\n\n\n\n');
                    console.log('\n\n\n\n\n\n');
    ...
    getInteractableContracts: function (network, apiKeys, walletPK, deployedContract, deployedContractABI) {
        var enableLogs = 0;
        var parsedNetwork = parseInt(network) ? parseInt(network) : network; // if chainId is
        var provider = ethers_1.ethers.getDefaultProvider(parsedNetwork, {

...
export default class NotificationHelper {
     ...
     */
    constructor(channelKey: string, { communicatorContractAddress, communicatorContractABI, channelAddress, networkKeys, notificationChainId, }?: {
    ...
    getContract(chainId: string, address: string, abi: string): Promise<{
        provider: ethers.providers.BaseProvider;
        contract: ethers.Contract;
        signingContract: ethers.Contract | null;
    }>;
